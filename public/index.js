...
(() => {
  ...
  var $$try = function(dictMonadError) {
    ...
    return function(a2) {
      return catchError1(map16(Right.create)(a2))(function($52) {
    ...
    return function(k) {
      var go2 = function(f) {
        ...
        if (v instanceof Return) {
          return map16(Done.create)(pure14(v.value0));
        }
        ;
        if (v instanceof Bind) {
          return map16(function($199) {
  ...
  var map6 = /* @__PURE__ */ map(functorHalogenM);
    ...
    return function(v) {
      ...
      if (v instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map6(maybe(v.value1(unit))(g));
          return function($46) {
  ...
  var map8 = /* @__PURE__ */ map(functorCoyoneda);
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect3(read(ref2)))(function(v) {
          return evalM(render2)(ref2)(v["component"]["eval"](new Query(map8(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect3(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect3(read(ref2)))(function(v2) {
                    return discard1(liftEffect3(modify_(map22(insert3(sid)(finalize)))(v2.subscriptions)))(function() {
                      return pure4(v1.value1(sid));
                    });
                  });
                });
              });
                ...
                return bind12(liftEffect3(read(ref2)))(function(v2) {
                  return bind12(liftEffect3($$new(false)))(function(doneRef) {
                    return bind12(fork3($$finally(liftEffect3(function __do3() {
                      ...
                      return discard1(liftEffect3(unlessM2(read(doneRef))(modify_(insert1(fid)(fiber))(v2.forks))))(function() {
                        return pure4(v1.value1(fid));
                      });
                    });
                  });
                });
            ...
            if (v1 instanceof GetRef) {
              return bind12(liftEffect3(read(ref2)))(function(v2) {
                return pure4(v1.value1(lookup22(v1.value0)(v2.refs)));
              });
            }
            ;
      ...
      return function(i2) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do3() {
                    var childrenIn = map9(slot.pop)(read(childrenInRef))();
                    var $$var2 = function() {
                    ...
                    var isDuplicate = map9(function($69) {
                    ...
                    return bind3(read($$var2))(renderStateX2(function(v) {
                      ...
                      ;
                      if (v instanceof Just) {
                        return pure5(renderSpec2.renderChild(v.value0));
                      }
                      ;
        ...
        var render2 = function(lchs) {
          return function($$var2) {
            return function __do3() {
              var v = read($$var2)();
              var shouldProcessHandlers = map9(isNothing)(read(v.pendingHandlers))();
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect5(map11(toDocument)(bindFlipped6(document)(windowImpl))))(function(document2) {
  ...
  var stat = function(number) {
    return function(label5) {
      return div2([attr2("class")("stat")])([div2([attr2("class")("stat-number")])([text5(number)]), div2([attr2("class")("stat-label")])([text5(label5)])]);
    };
  };
  var serviceCard = function(emoji) {
    return function(title3) {
      return function(description) {
        return div2([attr2("class")("service-card")])([div2([attr2("class")("service-emoji")])([text5(emoji)]), h3([attr2("class")("service-title")])([text5(title3)]), p([attr2("class")("service-description")])([text5(description)])]);
      };
    };
  };
  var section2 = function(sid) {
    return function(title3) {
      return function(body2) {
        return section([attr2("id")(sid), attr2("class")("section container")])(append5([h2([attr2("class")("section-title")])([text5(title3)])])(body2));
      };
    };
  };
  var services = /* @__PURE__ */ section2("services")("What I deliver")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("services-grid")])([/* @__PURE__ */ serviceCard("\u{1F504}")("Bulletproof CI/CD")("Self-hosted GitHub runners on NixOS. Automated dev \u2192 staging \u2192 prod pipeline with testing gates, rollback capabilities, and zero downtime deployments."), /* @__PURE__ */ serviceCard("\u{1F916}")("Private LLM Infrastructure")("Deploy secure, internal LLMs that can safely process your confidential data. Perfect for companies that need AI but can't use public APIs."), /* @__PURE__ */ serviceCard("\u{1F3A8}")("Type-Safe Frontends")("Full-stack functional development with Yesod, Reflex FRP, and PureScript. Reactive, composable UIs with compile-time guarantees and seamless backend integration."), /* @__PURE__ */ serviceCard("\u{1F5C4}\uFE0F")("Database Excellence")("PostgreSQL, Redis, or any database. Automated backups, migrations, monitoring, performance tuning. Managed cloud DB or self-hosted."), /* @__PURE__ */ serviceCard("\u{1F512}")("Security & Secrets")("SSL automation, Nginx hardening, secret management with sops/age, SSH security, and least-privilege access controls."), /* @__PURE__ */ serviceCard("\u{1F4CA}")("Observability Stack")("Grafana dashboards, Prometheus metrics, structured logging, SLOs, and intelligent alerting. Know what's happening before your users do.")])]);
  var testimonial = /* @__PURE__ */ section2("proof")("Selected Work")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("proof-grid")])([/* @__PURE__ */ figure([/* @__PURE__ */ attr2("class")("card quote-card")])([/* @__PURE__ */ blockquote([/* @__PURE__ */ attr2("class")("quote")])([/* @__PURE__ */ text5("\u201CFrom initial concept through production deployment, we architected and built "), /* @__PURE__ */ a([/* @__PURE__ */ href4("https://xpsoasis.org"), /* @__PURE__ */ attr2("target")("_blank")])([/* @__PURE__ */ text5("xpsoasis.org")]), /* @__PURE__ */ text5(" and "), /* @__PURE__ */ a([/* @__PURE__ */ href4("https://xesoasis.org"), /* @__PURE__ */ attr2("target")("_blank")])([/* @__PURE__ */ text5("xesoasis.org")]), /* @__PURE__ */ text5(" end-to-end: infra, CI/CD, reliability, and delivery. This isn\u2019t marketing\u2014these are running systems.\u201D")]), /* @__PURE__ */ figcaption([/* @__PURE__ */ attr2("class")("quote-author")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("author-title")])([/* @__PURE__ */ text5("\u2014 Live projects shipped by our team")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("muted")])([/* @__PURE__ */ text5("Production deployments \u2022 reproducible environments \u2022 documented handover")])])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card proof-card")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-kicker")])([/* @__PURE__ */ text5("What this looks like")]), /* @__PURE__ */ h3([/* @__PURE__ */ attr2("class")("card-title")])([/* @__PURE__ */ text5("Concrete deliverables")]), /* @__PURE__ */ ul([/* @__PURE__ */ attr2("class")("list-compact")])([/* @__PURE__ */ li_([/* @__PURE__ */ text5("Nix flake with hermetic builds (CI matches local)")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Immutable servers + atomic deploys + rollback")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Secrets managed (age/sops), no plaintext drift")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Dashboards + alerts with actionable SLOs")])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-actions")])([/* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-secondary btn-block"), /* @__PURE__ */ href4("#contact")])([/* @__PURE__ */ text5("Let\u2019s map your setup")])])])])]);
  var processStep = function(number) {
    return function(title3) {
      return function(description) {
        return div2([attr2("class")("process-step")])([div2([attr2("class")("process-number")])([text5(number)]), div2([attr2("class")("process-content")])([h4([attr2("class")("process-title")])([text5(title3)]), p([attr2("class")("process-description")])([text5(description)])])]);
      };
    };
  };
  var process = /* @__PURE__ */ section2("process")("How I work")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("process-flow")])([/* @__PURE__ */ processStep("01")("Audit")("Deep dive into your current setup, pain points, and requirements. Identify the biggest wins for reproducibility and reliability."), /* @__PURE__ */ processStep("02")("Design")("Create a Nix-first architecture plan with clear dev/staging/prod environments, testing strategies, and deployment workflows."), /* @__PURE__ */ processStep("03")("Build")("Implement with Nix flakes, set up CI/CD pipelines, configure monitoring, and establish security best practices."), /* @__PURE__ */ processStep("04")("Deploy")("Migrate to the new system with zero downtime, comprehensive testing, and full documentation handover.")])]);
  var pricingSpotlight = /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card pricing-card pricing-card--hero")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-kicker")])([/* @__PURE__ */ text5("First-week discount")]), /* @__PURE__ */ h3([/* @__PURE__ */ attr2("class")("card-title")])([/* @__PURE__ */ text5("Senior Infrastructure / FP")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pricing-amount")])([/* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-currency")])([/* @__PURE__ */ text5("$")]), /* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-number")])([/* @__PURE__ */ text5("30")]), /* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-period")])([/* @__PURE__ */ text5("/hour")])]), /* @__PURE__ */ p([/* @__PURE__ */ attr2("class")("muted")])([/* @__PURE__ */ text5("The first hour is free so we can set goals and decide if the discounted $30/hour first week is the right next step. For longer collaborations, we'll adjust scope and rate together.")]), /* @__PURE__ */ ul([/* @__PURE__ */ attr2("class")("list-compact")])([/* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2705 Reproducible dev/staging/prod")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2705 CI/CD with testing gates")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2705 Monitoring + rollback strategy")])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-actions")])([/* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-primary btn-block"), /* @__PURE__ */ href4("mailto:hhefesto@rdataa.com?subject=DevOps%20Transformation%20Inquiry")])([/* @__PURE__ */ text5("Start the conversation")]), /* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-secondary btn-block"), /* @__PURE__ */ href4("#contact")])([/* @__PURE__ */ text5("Free consultation")])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-footnote")])([/* @__PURE__ */ text5("Usually respond within 4 hours during UTC-6 business hours")])]);
  var pill = function(txt) {
    return span3([attr2("class")("pill")])([text5(txt)]);
  };
  var pricing = /* @__PURE__ */ section2("pricing")("Big first-week discount: $30/hour")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pricing-layout")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pricing-lede")])([/* @__PURE__ */ p([/* @__PURE__ */ attr2("class")("lead")])([/* @__PURE__ */ text5("Start with a free first-hour consultation to set goals, check fit, and decide whether to move into a heavily discounted first week at $30/hour. If the collaboration continues, we'll adjust the scope and rate around the longer-term plan.")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pill-row")])([/* @__PURE__ */ pill("Nix-first"), /* @__PURE__ */ pill("Security & secrets"), /* @__PURE__ */ pill("CI/CD + observability"), /* @__PURE__ */ pill("Docs + handover")])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pricing-cards")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card pricing-card pricing-card--main")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-kicker")])([/* @__PURE__ */ text5("First-week discount")]), /* @__PURE__ */ h3([/* @__PURE__ */ attr2("class")("card-title")])([/* @__PURE__ */ text5("Senior Infrastructure / FP")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("pricing-amount")])([/* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-currency")])([/* @__PURE__ */ text5("$")]), /* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-number")])([/* @__PURE__ */ text5("30")]), /* @__PURE__ */ span3([/* @__PURE__ */ attr2("class")("pricing-period")])([/* @__PURE__ */ text5("/hour")])]), /* @__PURE__ */ p([/* @__PURE__ */ attr2("class")("muted")])([/* @__PURE__ */ text5("A low-risk way to audit, prioritize, and start delivering a stable, reproducible baseline before committing long term.")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("split")])([/* @__PURE__ */ div_([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("split-title")])([/* @__PURE__ */ text5("Typical outcomes")]), /* @__PURE__ */ ul([/* @__PURE__ */ attr2("class")("list-compact")])([/* @__PURE__ */ li_([/* @__PURE__ */ text5("Hermetic dev shell & build")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Dev \u2192 staging \u2192 prod pipeline")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Observability + alerting")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Security & secrets management")])])]), /* @__PURE__ */ div_([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("split-title")])([/* @__PURE__ */ text5("How we start")]), /* @__PURE__ */ ul([/* @__PURE__ */ attr2("class")("list-compact")])([/* @__PURE__ */ li_([/* @__PURE__ */ text5("Free first-hour consultation")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Goals, fit, and one-week scope")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("Discounted first week if it makes sense")])])])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("card-actions")])([/* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-primary btn-block"), /* @__PURE__ */ href4("mailto:hhefesto@rdataa.com?subject=Availability%20Inquiry")])([/* @__PURE__ */ text5("Ask about availability")])])])])])]);
  ...
  var expertiseCard = function(title3) {
    return function(icon) {
      return function(features) {
        return div2([attr2("class")("expertise-card")])([div2([attr2("class")("expertise-header")])([div2([attr2("class")("expertise-icon " + icon)])([]), h3([attr2("class")("expertise-title")])([text5(title3)])]), ul([attr2("class")("expertise-features")])(map15(function(f) {
          return li_([text5(f)]);
        })(features))]);
      };
    };
  };
  var expertise = /* @__PURE__ */ section2("expertise")("My expertise")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("expertise-grid")])([/* @__PURE__ */ expertiseCard("Nix Ecosystem")("nix-logo")(["Nix flakes for hermetic environments", "NixOS for immutable infrastructure", "Zero-config dev shells that work everywhere", "Atomic rollbacks and perfect reproducibility"]), /* @__PURE__ */ expertiseCard("Functional Programming")("fp-logo")(["Haskell for bulletproof backend systems", "PureScript for type-safe frontends", "Immutable infrastructure principles", "Composable, testable system design"]), /* @__PURE__ */ expertiseCard("Multi-Cloud Mastery")("cloud-logo")(["AWS \u2022 GCP \u2022 Hetzner \u2022 OVH \u2022 Rumble", "Provider-agnostic infrastructure as code", "Cost optimization across platforms", "Migration strategies between clouds"])])]);
  var contact = /* @__PURE__ */ section2("contact")("Ready to bulletproof your infrastructure?")([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("contact-content")])([/* @__PURE__ */ p([/* @__PURE__ */ attr2("class")("contact-subtitle")])([/* @__PURE__ */ text5("Tell me about your current setup and where you want to be. I'll create a custom plan to get you there with Nix-powered reproducibility.")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("contact-methods")])([/* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-primary btn-large"), /* @__PURE__ */ href4("mailto:hhefesto@rdataa.com?subject=DevOps%20Transformation%20Inquiry")])([/* @__PURE__ */ text5("\u{1F4E7} Start the conversation")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("contact-note")])([/* @__PURE__ */ text5("Usually respond within 4 hours during UTC-6 business hours \u2022 Free consultation call")])])])]);
  var badge = function(text6) {
    return div2([attr2("class")("badge")])([text5(text6)]);
  };
  var hero = /* @__PURE__ */ section([/* @__PURE__ */ attr2("class")("hero container")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("hero-grid")])([/* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("hero-content")])([/* @__PURE__ */ badge("Nix \u2022 Reproducible \u2022 Bulletproof"), /* @__PURE__ */ h1([/* @__PURE__ */ attr2("class")("hero-title")])([/* @__PURE__ */ text5("Turn your prototype into bulletproof production infrastructure")]), /* @__PURE__ */ p([/* @__PURE__ */ attr2("class")("hero-subtitle")])([/* @__PURE__ */ text5("I specialize in "), /* @__PURE__ */ strong_([/* @__PURE__ */ text5("Nix flakes")]), /* @__PURE__ */ text5(" and "), /* @__PURE__ */ strong_([/* @__PURE__ */ text5("functional programming")]), /* @__PURE__ */ text5(" to build completely reproducible CI/CD pipelines. From dev \u2192 staging \u2192 prod with zero configuration drift, automated testing between stages, and deployments that work exactly the same every time.")]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("hero-cta")])([/* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-primary"), /* @__PURE__ */ href4("#contact")])([/* @__PURE__ */ text5("Transform your deployment")]), /* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-secondary"), /* @__PURE__ */ href4("#services")])([/* @__PURE__ */ text5("See what I build")]), /* @__PURE__ */ a([/* @__PURE__ */ attr2("class")("btn btn-tertiary"), /* @__PURE__ */ href4("#pricing")])([/* @__PURE__ */ text5("View pricing")])]), /* @__PURE__ */ div2([/* @__PURE__ */ attr2("class")("hero-stats")])([/* @__PURE__ */ stat("100%")("Reproducible"), /* @__PURE__ */ stat("0")("Config drift"), /* @__PURE__ */ stat("24/7")("Reliability")])]), /* @__PURE__ */ aside([/* @__PURE__ */ attr2("class")("hero-offer")])([pricingSpotlight])])]);
  var render = function(v) {
    return main_([hero, pricing, expertise, services, process, testimonial, contact]);
  };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(/* @__PURE__ */ liftEffect(monadEffectAff)(function __do2() {
    var win = windowImpl();
    var doc = document(win)();
    var docNode = toNonElementParentNode(toDocument(doc));
    return getElementById("root")(docNode)();
  }))(function(mRoot) {
    var v = bind15(mRoot)(fromElement);
    if (v instanceof Nothing) {
      return pure13(unit);
    }
    ;
    if (v instanceof Just) {
      return $$void7(runUI2(component)(unit)(v.value0));
    }
    ;
    throw new Error("Failed pattern match at Main (line 364, column 3 - line 366, column 50): " + [v.constructor.name]);
  }));
